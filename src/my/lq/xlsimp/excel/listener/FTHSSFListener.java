 ...
 * ids.
 */
public class FTHSSFListener implements HSSFListener {
	 ...
	 */
	public FTHSSFListener(HSSFListener childListener) {
		this(childListener, Locale.getDefault());
	}


	public FTHSSFListener setDateFormat(String dateFormat){
	...
	public String formatNumberDateCell(CellValueRecordInterface cell) {
	 ...
	 // System.out.println(HSSFDateUtil.isValidExcelDate(value));
	...
	public String getFormatString(int formatIndex) {
		...
		if(this.dateFormat != null && DateUtil.isADateFormat(formatIndex,format)) {
